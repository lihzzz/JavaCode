drop
database if exists s0;
create
database s0 default charset utf8;
use
s0;
...
drop
database if exists s1;
create
database s1 default charset utf8;
use
s1;
drop table if exists `t_user`;
create table `t_user`
...
drop
database if exists s2;
create
database s2 default charset utf8;
use
s2;
drop table if exists `t_user`;
create table `t_user`
...
drop
database if exists s3;
create
database s3 default charset utf8;
use
s3;
drop table if exists `t_user`;
create table `t_user`
