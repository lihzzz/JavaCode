...
//        String line;
//        var file = new File("src/main/java/data/sql/post.sql");
...
//        return DriverManager.getConnection("jdbc:mysql://localhost:3306/huge", "root", "HUANGJING");
//    }
//
//
//
...
//
//            // 10 threads
//            var buckets = this.num / this.bucket; // 10000
//
//            // 1 user -> 10 post
//            var totalUser = this.num/10; // 1000000
//            var userBuckets = buckets/10; // 100
//
